    ...
    <header class="coverage-vip10-hero">
        <div class="coverage-vip10-hero-overlay">
            <div class="coverage-vip10-hero-inner">
                ...
                <p class="coverage-vip10-hero-copy">{{ \App\Support\CoverageFormTranslations::en('vip10_intro') }}</p>
            </div>
        </div>
    </header>
    ...
    <div class="coverage-vip10-body">
        ...
        >
            ...
            <section class="coverage-vip10-section">
                <h2 class="coverage-vip10-section-title">{{ \App\Support\CoverageFormTranslations::en('personal_information') }}</h2>
                <div class="coverage-vip10-grid coverage-vip10-grid-2">
                    <div>
                        <label class="coverage-vip10-label">{{ \App\Support\CoverageFormTranslations::en('first_name') }}</label>
                        <input type="text" name="first_name" required value="{{ old('first_name', $primary?->first_name) }}" class="{{ $inputClass }}">
                    </div>
                    <div>
                        <label class="coverage-vip10-label">{{ \App\Support\CoverageFormTranslations::en('last_name') }}</label>
                        <input type="text" name="last_name" required value="{{ old('last_name', $primary?->last_name) }}" class="{{ $inputClass }}">
                    </div>
                    <div>
                        <label class="coverage-vip10-label">{{ \App\Support\CoverageFormTranslations::en('date_of_birth') }}</label>
                        <x-hero-date-input
                            name="date_of_birth"
                    ...
                    <div>
                        <label class="coverage-vip10-label">{{ \App\Support\CoverageFormTranslations::en('local_address') }}</label>
                        <input type="text" name="street" required value="{{ old('street', $primary?->street) }}" class="{{ $inputClass }}">
                    </div>
                    <div>
                        <label class="coverage-vip10-label">{{ \App\Support\CoverageFormTranslations::en('city') }}</label>
                        <input type="text" name="city" required value="{{ old('city', $primary?->city) }}" class="{{ $inputClass }}">
                    </div>
                    <div>
                        <label class="coverage-vip10-label">{{ \App\Support\CoverageFormTranslations::en('zip_code') }}</label>
                        <input type="text" name="zip_code" required value="{{ old('zip_code', $primary?->zip_code) }}" class="{{ $inputClass }}">
                    </div>
                    <div>
                        <label class="coverage-vip10-label">{{ \App\Support\CoverageFormTranslations::en('phone') }}</label>
                        <input type="text" name="phone" required value="{{ old('phone', $primary?->phone) }}" class="{{ $inputClass }}">
                    </div>
                    <div>
                        <label class="coverage-vip10-label">{{ \App\Support\CoverageFormTranslations::en('email') }}</label>
            ...
            <section class="coverage-vip10-section">
                <h2 class="coverage-vip10-section-title">{{ \App\Support\CoverageFormTranslations::en('mailing_address') }}</h2>
                <div class="coverage-vip10-grid coverage-vip10-grid-1">
                    <div>
                        <label class="coverage-vip10-label">{{ \App\Support\CoverageFormTranslations::en('street') }}</label>
                    ...
                    <div class="coverage-vip10-grid coverage-vip10-grid-2">
                        ...
                        <div>
                            <label class="coverage-vip10-label">{{ \App\Support\CoverageFormTranslations::en('state') }}</label>
                    ...
                    <div class="coverage-vip10-grid coverage-vip10-grid-2">
                        ...
                        <div>
                            <label class="coverage-vip10-label">{{ \App\Support\CoverageFormTranslations::en('country') }}</label>
            ...
            <section class="coverage-vip10-section">
                <h2 class="coverage-vip10-section-title">{{ \App\Support\CoverageFormTranslations::en('emergency_contact') }}</h2>
            ...
            <section class="coverage-vip10-section">
                <h2 class="coverage-vip10-section-title">{{ \App\Support\CoverageFormTranslations::en('trips') }}</h2>
                <div class="coverage-vip10-trip-table">
                    <div class="coverage-vip10-trip-head">
                        <span>{{ \App\Support\CoverageFormTranslations::en('trip_from') }}</span>
                        <span>{{ \App\Support\CoverageFormTranslations::en('trip_price') }}</span>
                        <span>{{ \App\Support\CoverageFormTranslations::en('trip_date') }}</span>
                        <span></span>
                    </div>
                    <template x-for="(row, index) in trips" :key="index">
                        <div class="coverage-vip10-trip-row">
                            <input type="text" class="{{ $inputClass }}" x-model="row.from" :name="`trips[${index}][from]`" required placeholder="{{ \App\Support\CoverageFormTranslations::en('trip_from') }}">
                            <input type="text" class="{{ $inputClass }}" x-model="row.price" :name="`trips[${index}][price]`" placeholder="{{ \App\Support\CoverageFormTranslations::en('trip_price') }}">
                            <input type="text" class="{{ $inputClass }} hero-date-input" x-model="row.date" :name="`trips[${index}][date]`" required autocomplete="off" placeholder="{{ \App\Support\CoverageFormTranslations::en('trip_date') }}">
                            <button type="button" class="coverage-vip10-remove" x-show="trips.length > 1" @click="removeTrip(index)">{{ \App\Support\CoverageFormTranslations::en('remove') }}</button>
                        </div>
                    </template>
                </div>
                <button type="button" class="coverage-vip10-add" @click="addTrip()">{{ \App\Support\CoverageFormTranslations::en('add_more') }}</button>
                <div class="coverage-vip10-total">
                    <label class="coverage-vip10-label">{{ \App\Support\CoverageFormTranslations::en('trip_total') }}</label>
                    <input type="text" name="trip_total" value="{{ old('trip_total', $profile?->trip_details['total'] ?? '') }}" class="{{ $inputClass }}">
                </div>
            </section>

            <section class="coverage-vip10-section">
                <h2 class="coverage-vip10-section-title">{{ \App\Support\CoverageFormTranslations::en('passport_section') }}</h2>
                <p class="coverage-vip10-notice">{{ \App\Support\CoverageFormTranslations::en('passport_name_notice') }}</p>
                <div class="coverage-vip10-grid coverage-vip10-grid-2">
                    <div>
                        <label class="coverage-vip10-label">{{ \App\Support\CoverageFormTranslations::en('country_of_citizenship') }}</label>
                        <input type="text" name="nationality" required value="{{ old('nationality', $primary?->nationality) }}" class="{{ $inputClass }}">
                    </div>
                    <div>
                        <label class="coverage-vip10-label">{{ \App\Support\CoverageFormTranslations::en('passport_issued_by') }}</label>
                    ...
                    <div class="coverage-vip10-grid-span-2">
                        <label class="coverage-vip10-label">{{ \App\Support\CoverageFormTranslations::en('id_number') }}</label>
            ...
            <section class="coverage-vip10-section">
                <h2 class="coverage-vip10-section-title">{{ \App\Support\CoverageFormTranslations::en('medical_section') }}</h2>
                <div class="coverage-vip10-grid coverage-vip10-grid-1">
                    <div>
                        <label class="coverage-vip10-label">{{ \App\Support\CoverageFormTranslations::en('allergies') }}</label>
                        <input type="text" name="allergies" value="{{ old('allergies', $profile?->allergies) }}" class="{{ $inputClass }}" placeholder="{{ \App\Support\CoverageFormTranslations::en('allergies_placeholder') }}">
                    </div>
                    <div>
                        <label class="coverage-vip10-label">{{ \App\Support\CoverageFormTranslations::en('chronic_conditions') }}</label>
                    ...
                    <div>
                        <p class="coverage-vip10-checklist-title">{{ \App\Support\CoverageFormTranslations::en('medical_checklist') }}</p>
                    ...
                    <div>
                        <label class="coverage-vip10-label">{{ \App\Support\CoverageFormTranslations::en('other_medical') }}</label>
            ...
            <section class="coverage-vip10-section">
                <h2 class="coverage-vip10-section-title">{{ \App\Support\CoverageFormTranslations::en('travel_preferences_section') }}</h2>
                <div class="coverage-vip10-checklist">
            ...
            <section class="coverage-vip10-section">
                <h2 class="coverage-vip10-section-title">{{ \App\Support\CoverageFormTranslations::en('terms_section') }}</h2>
            ...
            <section class="coverage-vip10-section">
                <h2 class="coverage-vip10-section-title">{{ \App\Support\CoverageFormTranslations::en('signature_section') }}</h2>
                <div class="coverage-vip10-grid coverage-vip10-grid-2">
                    <div>
                        <label class="coverage-vip10-label">{{ \App\Support\CoverageFormTranslations::en('applicant_signature') }}</label>
                    ...
                    <div>
                        <label class="coverage-vip10-label">{{ \App\Support\CoverageFormTranslations::en('signature_date') }}</label>
                        <x-hero-date-input
                            name="signature_date"
            ...
            <div class="coverage-vip10-submit-wrap">
                <button type="submit" class="coverage-vip10-submit">
                    {{ \App\Support\CoverageFormTranslations::en('continue') }}
                </button>
            </div>
        </form>
    </div>
