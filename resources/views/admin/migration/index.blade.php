    ...
    <div class="space-y-6">
        ...
        <div class="hero-portal-panel overflow-hidden">
            ...
            <ul class="list-disc space-y-2 p-6 pl-10 text-sm text-slate-700">
                ...
                <li><strong>B2B</strong> (<span class="font-mono">b2b_company</span>, <span class="font-mono">b2b_employee</span>) is CSV-only — not synced from AWS. <strong>Walk-in member</strong> supports retail, small business, and corporate plans.</li>
            </ul>
        </div>
    </div>
</x-portal-layout>
