        ...
        <tr>
            <td align="center" style="padding:24px 16px 40px;">
                <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="max-width:600px;margin:0 auto;">
                    <tr>
                        <td style="background:linear-gradient(135deg,#141d35 0%,#1e2a45 100%);background-color:#141d35;border-radius:16px 16px 0 0;padding:28px 32px 24px;text-align:left;">
