    ...
    <div class="space-y-8">
        ...
        <div>
            ...
            <div class="mt-1 flex flex-wrap items-center justify-between gap-4">
                <h1 class="font-display text-2xl font-bold tracking-tight text-slate-900 dark:text-slate-100">Retail Membership Plans</h1>
                <div class="flex flex-wrap items-center gap-4">
                    @include('plans.partials.admin-add-plan-link', ['from' => 'retail'])
        ...
        @include('plans.partials.retail-catalog', ['sections' => $retailCatalogSections])
    </div>
</x-portal-layout>
