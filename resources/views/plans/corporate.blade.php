    ...
    <div class="space-y-8">
        ...
        <div>
            ...
            <div class="mt-1 flex flex-wrap items-center justify-between gap-4">
                <h1 class="font-display text-2xl font-bold tracking-tight text-slate-900 dark:text-slate-100">Corporate Plans</h1>
                <div class="flex flex-wrap items-center gap-4">
                    @include('plans.partials.admin-add-plan-link', ['from' => 'corporate'])
        ...
        @include('plans.partials.small-business-catalog', [
            'sections' => $corporateCatalogSections,
            'membershipLabel' => 'Corporate membership',
            'plansReturn' => 'corporate',
        ])
    </div>
</x-portal-layout>
